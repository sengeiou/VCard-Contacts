...
package com.chebyr.vcardrealm.contacts.quickcontact;
...
import com.chebyr.vcardrealm.contacts.ContactSaveService;
import com.chebyr.vcardrealm.contacts.ContactsActivity;
import com.chebyr.vcardrealm.contacts.NfcHandler;
import com.chebyr.vcardrealm.contacts.R;
import com.chebyr.vcardrealm.contacts.detail.ContactDisplayUtils;
...
import com.chebyr.vcardrealm.contacts.interactions.CalendarInteractionsLoader;
import com.chebyr.vcardrealm.contacts.interactions.CallLogInteractionsLoader;
import com.chebyr.vcardrealm.contacts.interactions.ContactDeletionInteraction;
import com.chebyr.vcardrealm.contacts.interactions.ContactInteraction;
import com.chebyr.vcardrealm.contacts.interactions.SmsInteractionsLoader;
import com.chebyr.vcardrealm.contacts.util.ImageViewDrawableSetter;
...
public class QuickContactActivity extends ContactsActivity
{
     ...
     * This value for {@link QuickContact#EXTRA_MODE}
    ...
    private void initializeNoContactDetailCard() {
        final Drawable phoneIcon = getResources().getDrawable(
                R.mipmap.ic_phone_24dp).mutate();
        final ExpandingEntryCardView.Entry phonePromptEntry = new ExpandingEntryCardView.Entry(CARD_ENTRY_ID_EDIT_CONTACT,
                ...
                /* thirdAction = */ ExpandingEntryCardView.Entry.ACTION_NONE,
                /* thirdExtras = */ null,
                R.mipmap.ic_phone_24dp);

        final Drawable emailIcon = getResources().getDrawable(
                R.mipmap.ic_email_24dp).mutate();
        final ExpandingEntryCardView.Entry emailPromptEntry = new ExpandingEntryCardView.Entry(CARD_ENTRY_ID_EDIT_CONTACT,
                ...
                /* thirdAction = */ ExpandingEntryCardView.Entry.ACTION_NONE, /* thirdExtras = */ null,
                R.mipmap.ic_email_24dp);

        final List<List<ExpandingEntryCardView.Entry>> promptEntries = new ArrayList<>();
        promptEntries.add(new ArrayList<ExpandingEntryCardView.Entry>(1));
        promptEntries.add(new ArrayList<ExpandingEntryCardView.Entry>(1));
     ...
     */
    private static ExpandingEntryCardView.Entry dataItemToEntry(DataItem dataItem, DataItem secondDataItem,
        ...
        int thirdAction = ExpandingEntryCardView.Entry.ACTION_NONE;
        ...
        if (dataItem instanceof ImDataItem) {
            ...
            entryContextMenuInfo = new ExpandingEntryCardView.EntryContextMenuInfo(im.getData(), header,
            ...
            entryContextMenuInfo = new ExpandingEntryCardView.EntryContextMenuInfo(subHeader, header,
                    dataItem.getMimeType(), dataItem.getId(), dataItem.isSuperPrimary());
            ...
            } catch (final WebAddress.ParseException e) {
            ...
            entryContextMenuInfo = new ExpandingEntryCardView.EntryContextMenuInfo(text, header,
                    dataItem.getMimeType(), dataItem.getId(), dataItem.isSuperPrimary());
            ...
            if (!TextUtils.isEmpty(phone.getNumber())) {
                ...
                entryContextMenuInfo = new ExpandingEntryCardView.EntryContextMenuInfo(header,
                ...
                icon = res.getDrawable(R.mipmap.ic_phone_24dp);
                iconResourceId = R.mipmap.ic_phone_24dp;
                ...
                if (isCallWithSubjectSupported) {
                    ...
                    thirdAction = ExpandingEntryCardView.Entry.ACTION_INTENT;
            ...
            if (!TextUtils.isEmpty(address)) {
                ...
                primaryContentDescription.append(header);
                icon = res.getDrawable(R.mipmap.ic_email_24dp);
                iconResourceId = R.mipmap.ic_email_24dp;
            }
            ...
            if (!TextUtils.isEmpty(postalAddress)) {
                ...
                alternateIcon = res.getDrawable(R.mipmap.ic_directions_24dp);
                alternateContentDescription.append(res.getString(
                        R.string.content_description_directions)).append(" ").append(header);
                icon = res.getDrawable(R.mipmap.ic_place_24dp);
                iconResourceId = R.mipmap.ic_place_24dp;
            }
            ...
            if (!TextUtils.isEmpty(address)) {
                ...
                primaryContentDescription.append(header);
                icon = res.getDrawable(R.mipmap.ic_dialer_sip_black_24dp);
                iconResourceId = R.mipmap.ic_dialer_sip_black_24dp;
            }
                ...
                switch (mimetype) {
                    case MIMETYPE_GPLUS_PROFILE:
                        ...
                        if (secondDataItem != null) {
                            icon = res.getDrawable(R.mipmap.ic_google_plus_24dp);
                            alternateIcon = res.getDrawable(R.mipmap.ic_add_to_circles_black_24);
                            ...
                            if (GPLUS_PROFILE_DATA_5_ADD_TO_CIRCLE.equals(
                                ...
                                icon = res.getDrawable(R.mipmap.ic_add_to_circles_black_24);
                            } else {
                                icon = res.getDrawable(R.mipmap.ic_google_plus_24dp);
                            }
                        }
                    ...
                    case MIMETYPE_HANGOUTS:
                        ...
                        // alternate actions
                        if (secondDataItem != null) {
                            icon = res.getDrawable(R.mipmap.ic_hangout_24dp);
                            alternateIcon = res.getDrawable(R.mipmap.ic_hangout_video_24dp);
                            final GPlusOrHangoutsDataItemModel itemModel =
                                    new GPlusOrHangoutsDataItemModel(intent, alternateIntent,
                                            dataItem, secondDataItem, alternateContentDescription,
                                            header, text, context);
                            ...
                            if (HANGOUTS_DATA_5_VIDEO.equals(intent.getDataString())) {
                                icon = res.getDrawable(R.mipmap.ic_hangout_video_24dp);
                            } else {
                                icon = res.getDrawable(R.mipmap.ic_hangout_24dp);
                            }
                        }
                        break;
                    default:
                        entryContextMenuInfo = new ExpandingEntryCardView.EntryContextMenuInfo(header, mimetype,
        ...
        return new ExpandingEntryCardView.Entry(dataId, icon, header, subHeader, subHeaderIcon, text, textIcon,
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (mContactData != null) {
            ...
            if (DirectoryContactUtil.isDirectoryContact(mContactData) || InvisibleContactUtil
                ...
                editMenuItem.setIcon(R.mipmap.ic_create_24dp);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_create_contact_shortcut:
                ...
                return true;
            case R.id.menu_help:
                ContactsBindHelpUtils.launchHelpAndFeedbackForContactScreen(this);
                return true;
            default:
